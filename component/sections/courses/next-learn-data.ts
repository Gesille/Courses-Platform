...
export const COURSES: Course[] = [
  ...
  {
    id: "data-smart", number: "03", category: "Data Awareness", hook: "Would you know what to do with sensitive data?", title: "Handle Data Smartly", description: "Build everyday habits that protect personal, customer, and company data.", duration: "6 minutes", questions: 3, level: "Intermediate", accent: "caution", heroLabel: "PROTECT WHAT MATTERS", videoUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ", sharePointUrl: "#sharepoint-data",
  ...
  {
    id: "excel-foundations", number: "09", category: "Digital Skills", hook: "Could Excel save you time every week?", title: "Excel Foundations", description: "Learn the spreadsheet habits that make everyday reporting faster, clearer, and more reliable.", duration: "10 minutes", questions: 3, level: "Beginner", accent: "caution", heroLabel: "WORK SMARTER WITH DATA", videoUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ", sharePointUrl: "#sharepoint-excel",
